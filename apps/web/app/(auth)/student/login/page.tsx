      ...
      if (user) {
        ...
        if (userData) {
          if (userData.role === "business") {
            // Business user trying to access student login - redirect to business dashboard
    ...
    <div className="w-full max-w-md">
      <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Welcome back! Log in to continue</p>
        </div>
      ...
      <div className="text-center mt-6 space-y-2">
        <p className="text-slate-600">
          ...
          <Link href="/student/signup" className="text-primary hover:text-primary-dark font-medium">Sign up</Link>
        </p>
        <p className="text-slate-500 text-sm">
          Are you a business owner?{" "}
          <Link href="/business/login" className="text-emerald-600 hover:text-emerald-700 font-medium">Login here</Link>
        </p>
      </div>
    </div>
  );
