...
// Comprehensive list of country codes (195+ countries)
const COUNTRY_CODES = [
  ...
  { code: "+1869", country: "Saint Kitts", flag: "🇰🇳" },
  ...
  return (
    <div className={`flex gap-2 ${className}`}>
      <select
        ...
        className={`w-[110px] min-w-[110px] flex-shrink-0 px-2 py-3 rounded-xl border bg-white text-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all ${
      ...
      <div className="relative flex-1 min-w-0">
        <input
          ...
          maxLength={10}
          className={`w-full px-4 py-3 rounded-xl border bg-white text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all ${
            error || (!isValidLength && phoneNumber.length > 0) ? "border-red-500" : "border-slate-200"
          }`}
        />
...
// Helper function to validate phone number (exactly 10 digits after country code)
